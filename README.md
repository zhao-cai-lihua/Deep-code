...
- Direct and Plan collaboration modes use Harness's own `/plan off` and `/plan` controls. Deep code waits for a structured Harness Plan projection and fails closed instead of pretending a local mode switch worked.
