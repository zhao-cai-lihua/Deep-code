...
- A beginner-facing Work Receipt that flags dependency, automation, permission, persistence, deletion, and unusually broad changes as high impact. It states when rollback is unknown instead of presenting a changed-file list as a guaranteed checkpoint.
